        ...
        <div className="container">
          <div className="card">
            <div className="card-body">
              ...
              <a href="https://mattaj26.github.io/Weather-Dashboard/" target="_blank"><img src={weatherDash} width="100%" alt="second project" className="btn btn-primary"></img>
              </a>
            </div>
          </div>
        </div>
        <div className="container">
          <div className="card">
            <div className="card-body">
              ...
              <a href="https://just-another-text-editor-aivj.onrender.com/" target="_blank"><img src={jateImg} width="100%" alt="third project" className="btn btn-primary"></img>
              </a>
            </div>
          </div>
        </div>
